...
public class AppointmentsController {
    ...
    @PostMapping
    public ResponseEntity<AppointmentResource> createAppointment(@RequestBody AppointmentResource createAppointmentResource) {
        ...
        var getAppointmentQuery = new GetAppointmentByIdQuery(appointmentId);
        var appointment = appointmentQueryService.handle(getAppointmentQuery);
