package pe.edu.upc.mind.care.platform.searchandmatch.application.internal.commandservices;

import org.springframework.stereotype.Service;
import pe.edu.upc.mind.care.platform.searchandmatch.domain.exceptions.PsychologistNotFoundException;
import pe.edu.upc.mind.care.platform.searchandmatch.domain.exceptions.ReservationExeption;
import pe.edu.upc.mind.care.platform.searchandmatch.domain.exceptions.ScheduleNotFoundException;
...
import pe.edu.upc.mind.care.platform.searchandmatch.infrastructure.persistence.jpa.repositories.ReservationRepository;
import pe.edu.upc.mind.care.platform.searchandmatch.infrastructure.persistence.jpa.repositories.ScheduleRepository;
